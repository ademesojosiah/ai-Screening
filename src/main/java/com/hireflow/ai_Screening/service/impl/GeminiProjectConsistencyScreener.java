...
public class GeminiProjectConsistencyScreener implements ProjectConsistencyScreener {
    ...
    public ProjectConsistencyCompletedEvent score(ApplicationSubmittedEvent event) {
        try {
            ...
            log.warn("Project consistency AI provider call failed for {} - falling back to deterministic scoring: {}",
